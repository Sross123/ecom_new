...
export default function Example() {
    ...
    const onSubmit = async(data) => {
        try {
            const response = await axios.post(`http://194.163.34.72:5000/api/auth/register`,data);
                    ...
                    <form className="mt-8 mb-2 w-80 space-y-4" onSubmit={handleSubmit(onSubmit)}>
                        <div className="w-auto">
                            <Input
                                ...
                                className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg  w-full p-2.5 pl-7  focus:outline-none focus:ring-0"
                        ...
                        <div className="w-auto">
                            <Input
                                ...
                                className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg  w-full p-2.5 pl-7 focus:outline-none focus:ring-0"
                                icon={<MdOutlineAlternateEmail className='text-gray-600 relative top-3 left-2' />}
                        ...
                        <div className="w-auto">
                            <Input
                                ...
                                className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg w-full p-2.5 pl-7 focus:outline-none focus:ring-0" required=""
                                icon={show ? <AiFillEye onClick={() => setShow(!show)} className='text-gray-600 relative top-3 left-2' /> : <AiFillEyeInvisible onClick={() => setShow(!show)} className='text-gray-600 relative top-3 left-2' />}
